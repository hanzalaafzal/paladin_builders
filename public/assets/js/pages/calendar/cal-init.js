! function($) {
    ...
    /* on drop */
    CalendarApp.prototype.onDrop = function(eventObj, date,videotoken) {
            ...
            callAjax(date,videotoken).then((result)=>{
              alert(result);
              if(result==true){
    ...
    CalendarApp.prototype.init = function() {
            ...
            $this.$calendarObj = $this.$calendar.fullCalendar({
                ...
                drop: function(date) { $this.onDrop($(this), date,$(this).attr('data-id')); },
