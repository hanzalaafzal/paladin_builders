...
<!--===============================================================================================-->
  ...
  <style media="screen">
	...
	*, *:before, *:after {
	...
	.container {
		background-image: url('{{asset('frontend/bg-t.jpg')}}');
...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" style="background-image: url('{{asset('frontend/BG-1.jpg')}}'); !important">
        <!--
