    ...
    @media (max-width: 575px){
      .u-text-2 {
        ...
        .u-section-1 .u-image-1 {
          margin: 144px auto 0px 30px;
        }
    }

    .container {
      background-image: url('{{asset('frontend/BG-1.jpg')}}');
    ...
    <section class="u-align-center u-clearfix u-grey-90 u-section-1" id="carousel_ed6d">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="fr-view u-clearfix u-rich-text u-text u-text-2">
          <p>
            <span style="font-size: 1.875rem; font-weight: 700;">Thank you for participating in lucky draw. You will be notified once your payment is verified.</span>
          </p>
        </div>
      </div>
    </section>
